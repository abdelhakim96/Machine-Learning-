...
test=[1 1650 3];
test_norm(1)=1;
test_norm(2)=(test(2)-mu(1))/sigma(1);
test_norm(3)=(test(3)-mu(2))/sigma(2);
price = theta(1)*1+ theta(2)*test_norm(2)+ theta(3)*test_norm(3); % You should change this
size(price)
% ============================================================
...
price = theta(1)*1+ theta(2)*test(2)+ theta(3)*test(3); % You should change this
size(price)
